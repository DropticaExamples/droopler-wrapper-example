...
DEV_DOCKER_IMAGES = {
    'default': ('droptica/drupal-dev:droopler', './docker/custom_images/custom-dev'),
    'additional_images': [
      ('droptica/gulptheme', './docker/custom_images/gulp') # Gulp & libsass
    ]
}
